...
- `/conferences` 心理学、脑科学、认知科学与 AI 顶会页面，以及 `/api/conferences` 多维筛选 API。
- 13 个重点会议、20 个官方关键节点、会议/日期/版本/同步运行 D1 模型；精确日期进入统一日历，TBA 不伪造日期。
- 顶会官网错峰 Cron 巡检、版本留证、结构化日志，以及搜索、手机导航和系统状态集成。
