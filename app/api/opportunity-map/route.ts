...
const regionCenters={"英国":{x:499,y:106,labelEn:"United Kingdom"},"中国内地":{x:816,y:159,labelEn:"Mainland China"},"中国香港":{x:817,y:188,labelEn:"Hong Kong SAR"}}as const;
const places=[
