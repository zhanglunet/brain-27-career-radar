...
export default function PrdPage() {
  return <main className={styles.page}>
    ...
    <header className={styles.hero}>
      <div><p className={styles.eyebrow}>PRODUCT REQUIREMENTS / V0.12</p><h1>自动更新<span>需求文档</span></h1><p className={styles.lede}>自动检查可信来源、记录变化、保护最后可信内容；同时持续发现新的校招机会、公司和研究机构，并保证电脑和手机都能完整使用。</p></div>
      <aside className={styles.heroAside}><strong>2026.08.02</strong><p>P1.13 已增加持续发现：新机构和新机会保留证据并进入候选，核验后才公开发布。</p></aside>
    </header>
    ...
    <footer className={styles.footer}><span>BRAIN / 27 · PRD v0.12</span><p>产品边界：自动发现变化，不未经审核自动发布高风险判断。</p></footer>
  </main>;
}
