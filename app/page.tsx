  ...
  return (
    <main>
      <nav className="nav">
        ...
        <div className="navlinks"><a href="#radar">机会雷达</a><a href="/researchers">导师雷达</a><a href="/papers">最新论文</a><a href="#institutes">科研机构</a><a href="/sources">信息源</a><a href="/logs">采集日志</a><a href="/system">系统说明</a><a href="/prd">需求文档</a></div>
