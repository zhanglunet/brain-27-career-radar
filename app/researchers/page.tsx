...
export default function ResearchersPage() {
  return <main className={styles.page}>
    <nav className={styles.nav}><Link href="/" className={styles.brand}>BRAIN / 27</Link><div className={styles.navLinks}><Link href="/papers">最新论文</Link><Link href="/sources">信息源</Link><Link href="/logs">日志</Link><Link href="/prd/academic">P2 PRD</Link></div></nav>
