...
<header className={styles.hero}><div><p className={styles.eyebrow}>CLASS OF 2027 · CHINA · UK · HONG KONG</p><h1>2027 校招<br/><span>从现在开始投</span></h1><p className={styles.lede}>集中查看北京、上海优先的国内大厂、研究机构和大模型团队，同时跟踪英国顶级高校实验室、课题组、学院和导师岗位、英国企业 Graduate / Intern，以及香港企业与高校校招。</p></div><div className={styles.heroAside}><span>专项跟踪</span><strong>四条重点线 · 官方入口优先</strong><p>国内校招、英国顶级高校、英国企业、香港企业与高校；已开放批次、持续招聘入口和等待开放项目分开显示。</p></div></header>
