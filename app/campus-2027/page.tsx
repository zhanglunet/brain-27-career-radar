...
export default function Campus2027Page() {
  return <main className={styles.page}>
    ...
    <header className={styles.hero}><div><p className={styles.eyebrow}>CLASS OF 2027 · UK · HONG KONG · CHINA</p><h1>2027 校招<br/><span>从现在开始投</span></h1><p className={styles.lede}>集中查看英国顶级高校实验室、课题组、学院和导师岗位，英国企业 Graduate / Intern，以及香港企业与高校校招；同时保留国内大厂、研究机构和大模型团队。</p></div><div className={styles.heroAside}><span>专项跟踪</span><strong>官方入口优先</strong><p>已开放批次、持续招聘入口和等待开放项目分开显示，不把公司 Careers 首页包装成具体岗位。</p></div></header>
